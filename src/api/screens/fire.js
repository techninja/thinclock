  ...
  layers: [
    { type: 'particles', gravity: -8, edge: 'die',
      ...
      emitters: [
        ...
        { x: -1, y: 7, vx_min: -1.5, vx_max: 1.5, vy_min: -6, vy_max: -2, rate: 25, life_min: 300, life_max: 800, size: 1 },
        // Occasional larger sparks
        { x: -1, y: 7, vx_min: -2, vx_max: 2, vy_min: -8, vy_max: -4, rate: 3, life_min: 400, life_max: 1000, size: 1 },
      ],
    },
  ],
});
