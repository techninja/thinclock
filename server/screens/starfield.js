  ...
  layers: [
    { type: 'particles', gravity: 0, edge: 'die', warmup: 5000,
      ...
      emitters: [
        ...
        { x: 16, y: 4, vx_min: -3, vx_max: 3, vy_min: -1.5, vy_max: 1.5, rate: 3, life_min: 5000, life_max: 8000, size: 1 },
        { x: 16, y: 4, vx_min: -7, vx_max: 7, vy_min: -3.5, vy_max: 3.5, rate: 4, life_min: 2500, life_max: 4000, size: 1 },
        { x: 16, y: 4, vx_min: -14, vx_max: 14, vy_min: -7, vy_max: 7, rate: 3, life_min: 1500, life_max: 2500, size: 1 },
      ],
    },
  ],
});
